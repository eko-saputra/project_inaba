...
<head>
  ...
  <link rel="stylesheet" href="{{asset('assets/sd/fonts/icomoon/style.css')}}">

  <link rel="stylesheet" href="{{asset('assets/sd/css/bootstrap.min.css')}}">
  <link rel="stylesheet" href="{{asset('assets/sd/css/jquery-ui.css')}}">
  <link rel="stylesheet" href="{{asset('assets/sd/css/owl.carousel.min.css')}}">
  <link rel="stylesheet" href="{{asset('assets/sd/css/owl.theme.default.min.css')}}">
  <link rel="stylesheet" href="{{asset('assets/sd/css/owl.theme.default.min.css')}}">

  <link rel="stylesheet" href="{{asset('assets/sd/css/jquery.fancybox.min.css')}}">

  <link rel="stylesheet" href="{{asset('assets/sd/css/bootstrap-datepicker.css')}}">

  <link rel="stylesheet" href="fonts/flaticon/font/flaticon.css')}}">

  <link rel="stylesheet" href="{{asset('assets/sd/css/aos.css')}}">
  <link href="{{asset('assets/sd/css/jquery.mb.YTPlayer.min.css')}}" media="all" rel="stylesheet" type="text/css">

  <link rel="stylesheet" href="{{asset('assets/sd/css/style.css')}}">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 d-none d-lg-block">
            <a href="/" class="small mr-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner" style="background-image: linear-gradient( 135deg, #81FBB8 10%, #28C76F 100%);">
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('{{asset('assets/sd/images/hero_1.jpg')}}');">
        <div class="container">
          <div class="row align-items-center">
  ...
  <script src="{{asset('assets/sd/js/jquery-3.3.1.min.js')}}"></script>
  <script src="{{asset('assets/sd/js/jquery-migrate-3.0.1.min.js')}}"></script>
  <script src="{{asset('assets/sd/js/jquery-ui.js')}}"></script>
  <script src="{{asset('assets/sd/js/popper.min.js')}}"></script>
  <script src="{{asset('assets/sd/js/bootstrap.min.js')}}"></script>
  <script src="{{asset('assets/sd/js/owl.carousel.min.js')}}"></script>
  <script src="{{asset('assets/sd/js/jquery.stellar.min.js')}}"></script>
  <script src="{{asset('assets/sd/js/jquery.countdown.min.js')}}"></script>
  <script src="{{asset('assets/sd/js/bootstrap-datepicker.min.js')}}"></script>
  <script src="{{asset('assets/sd/js/jquery.easing.1.3.js')}}"></script>
  <script src="{{asset('assets/sd/js/aos.js')}}"></script>
  <script src="{{asset('assets/sd/js/jquery.fancybox.min.js')}}"></script>
  <script src="{{asset('assets/sd/js/jquery.sticky.js')}}"></script>
  <script src="{{asset('assets/sd/js/jquery.mb.YTPlayer.min.js')}}"></script>




  <script src="{{asset('assets/sd/js/main.js')}}"></script>
